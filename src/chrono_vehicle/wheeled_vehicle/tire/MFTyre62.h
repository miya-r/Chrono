...
class CH_VEHICLE_API MFTyre62 : public ChMFTyre62 {
  public:
    MFTyre62(const std::string& filename);
    MFTyre62(const rapidjson::Document& d);
    ~MFTyre62() {}
    ...
    virtual void SetMFTyre62Params() override {}
