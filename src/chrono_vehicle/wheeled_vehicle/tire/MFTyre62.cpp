...
#include "chrono_vehicle/wheeled_vehicle/tire/MFTyre62.h"
...
// -----------------------------------------------------------------------------
// -----------------------------------------------------------------------------
MFTyre62::MFTyre62(const std::string& filename)
    : ChMFTyre62(""), m_mass(0), m_has_mesh(false), m_has_vert_table(false), m_has_bott_table(false) {
...
MFTyre62::MFTyre62(const rapidjson::Document& d)
    : ChMFTyre62(""), m_mass(0), m_has_mesh(false), m_has_vert_table(false), m_has_bott_table(false) {
    Create(d);
}

void MFTyre62::Create(const rapidjson::Document& d) {  // Invoke base class method.
    ChPart::Create(d);
    ...
    if (d.HasMember("Conditions")) {
        m_PacCoeff.InflPres = d["Dimension"]["InflPres"].GetDouble();
        m_PacCoeff.InflPres = d["NomPres"]["NomPres"].GetDouble();
    } else {
        GetLog() << "Couldn't find mandatory block 'Conditions' in JSON file.\n";
    }
    ...
    if (d.HasMember("Scaling Factors")) {
        ...
        if (d["Scaling Factors"].HasMember("lkyc")) {
            m_PacScal.lkyc = d["Scaling Factors"]["lkyc"].GetDouble();
        }
        if (d["Scaling Factors"].HasMember("lkzc")) {
            m_PacScal.lkzc = d["Scaling Factors"]["lkzc"].GetDouble();
        }
        ...
        if (d["Scaling Factors"].HasMember("lmp")) {
            m_PacScal.lmp = d["Scaling Factors"]["lmp"].GetDouble();
        }
    } else {
    ...
    if (d.HasMember("Longitudinal Coefficients")) {
        ...
        if (d["Longitudinal Coefficients"].HasMember("ppx1")) {
            m_PacCoeff.ppx1 = d["Longitudinal Coefficients"]["ppx1"].GetDouble();
        }
        if (d["Longitudinal Coefficients"].HasMember("ppx2")) {
            m_PacCoeff.ppx2 = d["Longitudinal Coefficients"]["ppx2"].GetDouble();
        }
        if (d["Longitudinal Coefficients"].HasMember("ppx3")) {
            m_PacCoeff.ppx3 = d["Longitudinal Coefficients"]["ppx3"].GetDouble();
        }
        if (d["Longitudinal Coefficients"].HasMember("ppx4")) {
            m_PacCoeff.ppx4 = d["Longitudinal Coefficients"]["ppx4"].GetDouble();
        }
        ...
        if (d["Longitudinal Coefficients"].HasMember("rbx3")) {
            m_PacCoeff.rbx3 = d["Longitudinal Coefficients"]["rbx3"].GetDouble();
        }
    ...
    if (d.HasMember("Lateral Coefficients")) {
        ...
        if (d["Lateral Coefficients"].HasMember("pey5")) {
            m_PacCoeff.pey5 = d["Lateral Coefficients"]["pey5"].GetDouble();
        }
        ...
        if (d["Lateral Coefficients"].HasMember("pky4")) {
            m_PacCoeff.pky4 = d["Lateral Coefficients"]["pky4"].GetDouble();
        }
        if (d["Lateral Coefficients"].HasMember("pky5")) {
            m_PacCoeff.pky5 = d["Lateral Coefficients"]["pky5"].GetDouble();
        }
        if (d["Lateral Coefficients"].HasMember("pky6")) {
            m_PacCoeff.pky6 = d["Lateral Coefficients"]["pky6"].GetDouble();
        }
        if (d["Lateral Coefficients"].HasMember("pky7")) {
            m_PacCoeff.pky7 = d["Lateral Coefficients"]["pky7"].GetDouble();
        }
        ...
        if (d["Lateral Coefficients"].HasMember("ppy1")) {
            m_PacCoeff.ppy1 = d["Lateral Coefficients"]["ppy1"].GetDouble();
        }
        if (d["Lateral Coefficients"].HasMember("ppy2")) {
            m_PacCoeff.ppy2 = d["Lateral Coefficients"]["ppy2"].GetDouble();
        }
        if (d["Lateral Coefficients"].HasMember("ppy3")) {
            m_PacCoeff.ppy3 = d["Lateral Coefficients"]["ppy3"].GetDouble();
        }
        if (d["Lateral Coefficients"].HasMember("ppy4")) {
            m_PacCoeff.ppy4 = d["Lateral Coefficients"]["ppy4"].GetDouble();
        }
        if (d["Lateral Coefficients"].HasMember("ppy5")) {
            m_PacCoeff.ppy5 = d["Lateral Coefficients"]["ppy5"].GetDouble();
        }
        ...
        if (d["Lateral Coefficients"].HasMember("rby4")) {
            m_PacCoeff.rby4 = d["Lateral Coefficients"]["rby4"].GetDouble();
        }
    ...
    if (d.HasMember("Aligning Coefficients")) {
        ...
        if (d["Aligning Coefficients"].HasMember("qdz10")) {
            m_PacCoeff.qdz10 = d["Aligning Coefficients"]["qdz10"].GetDouble();
        }
        if (d["Aligning Coefficients"].HasMember("qdz11")) {
            m_PacCoeff.qdz11 = d["Aligning Coefficients"]["qdz11"].GetDouble();
        }
        ...
        if (d["Aligning Coefficients"].HasMember("ppz1")) {
            m_PacCoeff.ppz1 = d["Aligning Coefficients"]["ppz1"].GetDouble();
        }
        if (d["Aligning Coefficients"].HasMember("ppz2")) {
            m_PacCoeff.ppz2 = d["Aligning Coefficients"]["ppz2"].GetDouble();
        }
    ...
    if (d.HasMember("Rolling Coefficients")) {
        ...
        if (d["Rolling Coefficients"].HasMember("qsy8")) {
            m_PacCoeff.qsy8 = d["Rolling Coefficients"]["qsy8"].GetDouble();
        }
    }
    if (d.HasMember("Overturning Coefficients")) {
        ...
        if (d["Overturning Coefficients"].HasMember("qsx12")) {
            m_PacCoeff.qsx12 = d["Overturning Coefficients"]["qsx12"].GetDouble();
        }
        if (d["Overturning Coefficients"].HasMember("qsx13")) {
            m_PacCoeff.qsx13 = d["Overturning Coefficients"]["qsx13"].GetDouble();
        }
        if (d["Overturning Coefficients"].HasMember("qsx14")) {
            m_PacCoeff.qsx14 = d["Overturning Coefficients"]["qsx14"].GetDouble();
        }
        if (d["Overturning Coefficients"].HasMember("ppmx1")) {
            m_PacCoeff.ppmx1 = d["Overturning Coefficients"]["ppmx1"].GetDouble();
        }
    }
...
void MFTyre62::AddVisualizationAssets(VisualizationType vis) {
    if (vis == VisualizationType::MESH && m_has_mesh) {
        ...
        ChMFTyre62::AddVisualizationAssets(vis);
    }
}

void MFTyre62::RemoveVisualizationAssets() {
    ChMFTyre62::RemoveVisualizationAssets();
